...
For those of you that don't want your fingers to bleed, this kata already has a
dictionary typed out for you.
...
def nato(word):
    return ' '.join(map(lambda x: letters[x.upper()], list(word)))
